...
class DiffTf:
    ...
    def __init__(self):
        ...
        self.ticks_meter = float(rospy.get_param('ticks_meter', 0.01))  # The number of wheel encoder ticks per meter of travel
        self.base_width = float(rospy.get_param('base_width', 0.01)) # The wheel base width in meters
        #rospy.loginfo("self.base_width: %s" % self.base_width)
        #rospy.loginfo("self.ticks_meter: %s" % self.ticks_meter)
